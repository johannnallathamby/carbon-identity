 ...
 */
public class OIDCUserInfoMessageContext<T1 extends OAuth2Request, T2 extends OAuth2Response,
    ...
    public OIDCUserInfoMessageContext(T1 request, T2 response, String tenantDomain, Map<T3, T4> parameters) {
