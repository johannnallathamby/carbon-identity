 ...
 */
public class OIDCUserInfoMessageContext<T1 extends Serializable, T2 extends Serializable> extends OAuth2MessageContext {

    private static final long serialVersionUID = 8957814451266828857L;

    public OIDCUserInfoMessageContext(OIDCUserInfoRequest request, OIDCUserInfoResponse response, String tenantDomain,
