...
public class BasicAuthHandler extends ClientAuthHandler {
    ...
    @Override
    public ClientType clientType(OAuth2MessageContext messageContext) throws OAuth2Exception {
        return null;
    }

    @Override
    public String authenticate(OAuth2MessageContext messageContext) throws OAuth2Exception {
        return null;
    }
}
