 ...
 */
public class RefreshGrantProcessor extends TokenProcessor {

    private static Log log = LogFactory.getLog(RefreshGrantProcessor.class);

    @Override
    public String getName() {
        return "RefreshGrantProcessor";
    }
