...
public class OAuth2InboundRequest extends InboundRequest {

    private static final long serialVersionUID = 5255384558894431030L;

    protected OAuth2InboundRequest(InboundRequestBuilder builder) {
        super(builder);
    }

    public static class OAuth2InboundRequestBuilder extends InboundRequestBuilder {

        public OAuth2InboundRequestBuilder(HttpServletRequest request, HttpServletResponse response) {
            super(request, response);
        }

        public OAuth2InboundRequestBuilder() {
