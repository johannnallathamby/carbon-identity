 ...
 */
public class PasswordGrantProcessor extends TokenProcessor {

    private static Log log = LogFactory.getLog(PasswordGrantProcessor.class);

    @Override
    public String getName() {
        return "PasswordGrantProcessor";
    }
