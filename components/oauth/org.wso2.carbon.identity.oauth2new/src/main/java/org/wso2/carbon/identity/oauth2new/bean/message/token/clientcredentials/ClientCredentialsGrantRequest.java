...
package org.wso2.carbon.identity.oauth2new.bean.message.token.clientcredentials;
...
public class ClientCredentialsGrantRequest extends OAuth2TokenRequest {
    ...
    public static class ClientCredentialsGrantBuilder extends TokenRequestBuilder {
        ...
        @Override
        public ClientCredentialsGrantRequest build() throws FrameworkRuntimeException {
