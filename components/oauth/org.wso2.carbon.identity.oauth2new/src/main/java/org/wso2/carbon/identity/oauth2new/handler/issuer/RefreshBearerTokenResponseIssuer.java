...
public class  RefreshBearerTokenResponseIssuer extends BearerTokenResponseIssuer {

    private static Log log = LogFactory.getLog(RefreshBearerTokenResponseIssuer.class);
