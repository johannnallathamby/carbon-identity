...
public class AccessTokenPersistenceTask implements Runnable {
    ...
    private BlockingDeque<AccessTokenPersistenceDO> accessTokenPersistenceQueue;

    public AccessTokenPersistenceTask(BlockingDeque<AccessTokenPersistenceDO> accessTokenPersistenceQueue) {
        this.accessTokenPersistenceQueue = accessTokenPersistenceQueue;
    }
