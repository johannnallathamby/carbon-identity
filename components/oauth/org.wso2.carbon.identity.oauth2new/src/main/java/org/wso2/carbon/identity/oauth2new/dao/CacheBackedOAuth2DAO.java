...
public class CacheBackedOAuth2DAO extends OAuth2DAO {
    ...
    public void storeAccessToken(AccessToken newAccessToken, String oldAccessToken, String authorizationCode,
                                 OAuth2MessageContext messageContext) throws
    ...
    @Override
    public AuthzCode getAuthzCode(String authorizationCode, OAuth2MessageContext messageContext) throws
            OAuth2RuntimeException {
    ...
    @Override
    public void updateAuthzCodeState(String authorizationCode, String state, OAuth2MessageContext messageContext) throws
            OAuth2RuntimeException {
    ...
    @Override
    public Set<String> getAuthorizedClientIDs(AuthenticatedUser authzUser, RevocationMessageContext messageContext) throws OAuth2RuntimeException {
    ...
    @Override
    public void revokeAccessToken(String bearerToken, RevocationMessageContext messageContext) throws
    ...
    @Override
    public void revokeRefreshToken(String refreshToken, RevocationMessageContext messageContext) throws OAuth2RuntimeException {
