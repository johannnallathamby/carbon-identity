...
public abstract class OAuth2InboundRequestProcessor extends InboundProcessor {
     ...
     */
    public boolean issueRefreshToken(OAuth2MessageContext messageContext) throws OAuth2RuntimeException {
     ...
     * @return {@code true} if refresh tokens must be issued
     */
    protected boolean issueRefreshToken(OAuth2AuthzMessageContext messageContext) throws OAuth2RuntimeException {
        return false;
    }
     ...
     * @return {@code true} if refresh tokens must be issued
     */
    protected boolean issueRefreshToken(OAuth2TokenMessageContext messageContext) throws OAuth2RuntimeException {
